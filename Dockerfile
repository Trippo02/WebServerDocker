...
COPY serverwebmain.jar /root/
COPY esdbpersona.sql /root/
CMD service mysql start && mysql -u root -p01-2W-Lq < /root/esdbpersona.sql && java -jar /root/webservermain.jar